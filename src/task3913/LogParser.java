...
public class LogParser implements IPQuery, UserQuery, DateQuery, EventQuery, QLQuery {
    ...
    public Set<String> getUsersForIP(String ip, Date after, Date before) {
        ...
        for (int i = 0; i < logEntities.size(); i++) {
            if (dateBetweenDates(logEntities.get(i).getDate(), after, before) &&
                    logEntities.get(i).getIp().equals(ip)) {
                result.add(logEntities.get(i).getUser());
            }
        }
        return result;
    ...
    public Set<Date> getDatesForUserAndEvent(String user, Event event, Date after, Date before) {
        ...
        for (int i = 0; i < logEntities.size(); i++) {
            if (dateBetweenDates(logEntities.get(i).getDate(), after, before) &&
            logEntities.get(i).getUser().equals(user) && logEntities.get(i).getEvent().equals(event)) {
    ...
    public Set<Date> getDatesWhenSomethingFailed(Date after, Date before) {
        ...
        for (int i = 0; i < logEntities.size(); i++) {
            if (dateBetweenDates(logEntities.get(i).getDate(), after, before) &&
            logEntities.get(i).getStatus().equals(Status.FAILED)) {
                result.add(logEntities.get(i).getDate());
            }
        }
        return result;
    ...
    public Set<Date> getDatesWhenErrorHappened(Date after, Date before) {
        ...
        for (int i = 0; i < logEntities.size(); i++) {
            if (dateBetweenDates(logEntities.get(i).getDate(), after, before) &&
                    logEntities.get(i).getStatus().equals(Status.ERROR)) {
                result.add(logEntities.get(i).getDate());
            }
        }
        return result;
